...
Namespace RichEditCustomCopyPaste
	Public Class CF_HTMLHelper
		...
		Private Const bodyTag As String = "<body>" & vbCrLf
		Private Const bodyTagClose As String = "</body>"
		Private Const EmptyDescription As String = "Version:0.9" & vbCrLf & "StartHTML:{0:D10}" & vbCrLf & "EndHTML:{1:D10}" & vbCrLf & "StartFragment:{2:D10}" & vbCrLf & "EndFragment:{3:D10}" & vbCrLf
