...
namespace RichEditCustomCopyPaste {
    public class CustomCopySelectionCommand : CopySelectionCommand {
        ...
        protected override void ExecuteCore() {
            ...
            data.SetData(RichEditDataFormats.Rtf, richEditControl.Document.GetRtfText(richEditControl.Document.Selection));
            data.SetData(RichEditDataFormats.UnicodeText, richEditControl.Document.GetText(richEditControl.Document.Selection));
            data.SetData(RichEditDataFormats.Html, htmlForClipboard);
            Clipboard.Clear();
